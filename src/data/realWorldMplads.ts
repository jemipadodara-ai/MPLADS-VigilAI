export interface RealWorldConstituency {
  id: string;
  name: string;
  state: string;
  seatCode: string;
  ...
  lat: number;
  lng: number;
  scSpentPercent: number;
  stSpentPercent: number;
  auditStatus: string;
  flaggedCount: number;
  lastAudited: string;
  callouts: {
    duplicationTitle: string;
    duplicationDesc: string;
    duplicationMetric: string;
    delayTitle: string;
    delayDesc: string;
    delayMetric: string;
  };
...
export const REAL_WORLD_CONSTITUENCIES: RealWorldConstituency[] = [
  {
    id: "varanasi",
    name: "Varanasi",
    state: "Uttar Pradesh",
