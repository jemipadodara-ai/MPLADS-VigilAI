        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <span className="px-2.5 py-0.5 rounded-md bg-indigo-50 border border-indigo-200 text-indigo-700 text-[11px] font-bold uppercase tracking-wider">
              {t('Spatial Telemetry / GIS', 'Spatial Telemetry / GIS')}
            </span>
            <span className="text-slate-300">•</span>
            <span className="text-slate-500 text-xs font-medium">
              {t('Geographic Information System', 'Geographic Information System')}
            </span>
          </div>
          <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">
            {t('map.gisTitle', 'GIS Map Intelligence & Spatial Anomaly Radar')}
          </h1>
          <p className="text-xs sm:text-sm text-slate-500">
            {t('map.gisSubtitle', 'Geocoded overlay of monitored development works to detect geographic clustering and proximity flags.')}
          </p>
        </div>

        <div className="flex items-center gap-3">
          <div className="px-3 py-2 rounded-xl bg-slate-50 border border-slate-200 text-xs font-medium text-slate-700">
            <span className="text-slate-400">{t('Mapped Works:', 'Mapped Works:')} </span>
          ...
          <div className="px-3 py-2 rounded-xl bg-rose-50 border border-rose-200 text-xs font-medium text-rose-700">
            <span className="text-rose-500">{t('Spatial Hotspots:', 'Spatial Hotspots:')} </span>
